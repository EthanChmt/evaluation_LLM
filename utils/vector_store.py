...
class VectorStoreManager:
    ...
    @logfire.instrument("Découpage des documents")
    ...
    @logfire.instrument("Génération des embeddings")
    ...
    @logfire.instrument("Construction de l'index")
    ...
    @logfire.instrument("Recherche de chunks")
